# Generated by Django 2.2 on 2019-04-18 14:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descr_var', models.CharField(blank=True, max_length=256, null=True)),
            ],
            options={
                'db_table': 'test',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField()),
                ('movies', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ratings', to='webapp.Movie')),
            ],
            options={
                'db_table': 'ratings',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movies', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='participants', to='webapp.Movie')),
                ('persons', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='participants', to='webapp.Person')),
                ('roles', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='participants', to='webapp.Role')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default=None, max_length=2048)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='OC', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
                'db_table': 'users',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('movies', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_ratings', to='webapp.Movie')),
                ('users', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_ratings', to='webapp.OCUser')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ip', models.CharField(blank=True, max_length=15, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('movies', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hits', to='webapp.Movie')),
                ('users', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hits', to='webapp.OCUser')),
            ],
            options={
                'db_table': 'hits',
            },
        ...
        migrations.AddField(
            model_name='comment',
            name='to_user',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='comment', to='webapp.OCUser'),
        ),
        migrations.AddField(
            model_name='comment',
            name='users',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='comments', to='webapp.OCUser'),
        ),
        migrations.CreateModel(
            name='Bookmark',
            fields=[
                ('bookmark_id', models.AutoField(primary_key=True, serialize=False)),
                ('movies', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bookmarks', to='webapp.Movie')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='bookmarks', to='webapp.OCUser')),
            ],
            options={
                'db_table': 'bookmarks',
            },
