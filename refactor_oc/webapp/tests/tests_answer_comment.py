...
class CommentAddTests(TestCase):
    ...
    def test_details(self):
        response = self.client.post(reverse('webapp:answer_comment'),
                                    {'movie_id': 4, 'text': 'Хороший фильм', 'user_pk': 1, 'to_comment_id': 5})
        ...
        self.assertTrue('to_comment_id' in response[0])
